...
var Ziggy = {
    namedRoutes: { "debugbar.openhandler": { "uri": "_debugbar\/open", "methods": ["GET", "HEAD"], "domain": null }, "debugbar.clockwork": { "uri": "_debugbar\/clockwork\/{id}", "methods": ["GET", "HEAD"], "domain": null }, "debugbar.telescope": { "uri": "_debugbar\/telescope\/{id}", "methods": ["GET", "HEAD"], "domain": null }, "debugbar.assets.css": { "uri": "_debugbar\/assets\/stylesheets", "methods": ["GET", "HEAD"], "domain": null }, "debugbar.assets.js": { "uri": "_debugbar\/assets\/javascript", "methods": ["GET", "HEAD"], "domain": null }, "debugbar.cache.delete": { "uri": "_debugbar\/cache\/{key}\/{tags?}", "methods": ["DELETE"], "domain": null }, "bone.captcha.image": { "uri": "captcha\/image", "methods": ["GET", "HEAD"], "domain": null }, "bone.captcha.image.tag": { "uri": "captcha\/image_tag", "methods": ["GET", "HEAD"], "domain": null }, "license.create": { "uri": "license", "methods": ["GET", "HEAD"], "domain": null }, "license.store": { "uri": "license", "methods": ["POST"], "domain": null }, "account.dashboard.index": { "uri": "en\/account", "methods": ["GET", "HEAD"], "domain": null }, "account.profile.edit": { "uri": "en\/account\/profile", "methods": ["GET", "HEAD"], "domain": null }, "account.profile.update": { "uri": "en\/account\/profile", "methods": ["PUT"], "domain": null }, "account.orders.index": { "uri": "en\/account\/orders", "methods": ["GET", "HEAD"], "domain": null }, "account.orders.show": { "uri": "en\/account\/orders\/{id}", "methods": ["GET", "HEAD"], "domain": null }, "account.wishlist.index": { "uri": "en\/account\/wishlist", "methods": ["GET", "HEAD"], "domain": null }, "account.wishlist.destroy": { "uri": "en\/account\/wishlist\/{productId}", "methods": ["DELETE"], "domain": null }, "account.reviews.index": { "uri": "en\/account\/reviews", "methods": ["GET", "HEAD"], "domain": null }, "products.index": { "uri": "en\/products", "methods": ["GET", "HEAD"], "domain": null }, "products.show": { "uri": "en\/products\/{slug}", "methods": ["GET", "HEAD"], "domain": null }, "login": { "uri": "en\/login", "methods": ["GET", "HEAD"], "domain": null }, "login.post": { "uri": "en\/login", "methods": ["POST"], "domain": null }, "login.redirect": { "uri": "en\/login\/{provider}", "methods": ["GET", "HEAD"], "domain": null }, "login.callback": { "uri": "en\/login\/{provider}\/callback", "methods": ["GET", "HEAD"], "domain": null }, "logout": { "uri": "en\/logout", "methods": ["GET", "HEAD"], "domain": null }, "register": { "uri": "en\/register", "methods": ["GET", "HEAD"], "domain": null }, "register.post": { "uri": "en\/register", "methods": ["POST"], "domain": null }, "reset": { "uri": "en\/password\/reset", "methods": ["GET", "HEAD"], "domain": null }, "reset.post": { "uri": "en\/password\/reset", "methods": ["POST"], "domain": null }, "reset.complete": { "uri": "en\/password\/reset\/{email}\/{code}", "methods": ["GET", "HEAD"], "domain": null }, "reset.complete.post": { "uri": "en\/password\/reset\/{email}\/{code}", "methods": ["POST"], "domain": null }, "cart.taxes.store": { "uri": "en\/cart\/taxes", "methods": ["POST"], "domain": null }, "products.reviews.store": { "uri": "en\/products\/{productId}\/reviews", "methods": ["POST"], "domain": null }, "current_currency.store": { "uri": "en\/current-currency\/{code}", "methods": ["GET", "HEAD"], "domain": null }, "cart.coupon.store": { "uri": "en\/cart\/coupon", "methods": ["POST"], "domain": null }, "contact.create": { "uri": "en\/contact", "methods": ["GET", "HEAD"], "domain": null }, "contact.store": { "uri": "en\/contact", "methods": ["POST"], "domain": null }, "compare.index": { "uri": "en\/compare", "methods": ["GET", "HEAD"], "domain": null }, "compare.store": { "uri": "en\/compare", "methods": ["POST"], "domain": null }, "compare.destroy": { "uri": "en\/compare\/{id}", "methods": ["DELETE"], "domain": null }, "checkout.create": { "uri": "en\/checkout", "methods": ["GET", "HEAD"], "domain": null }, "checkout.store": { "uri": "en\/checkout", "methods": ["POST"], "domain": null }, "checkout.complete.store": { "uri": "en\/checkout\/complete\/{orderId}\/{paymentGateway}", "methods": ["GET", "HEAD"], "domain": null }, "checkout.complete.show": { "uri": "en\/checkout\/complete", "methods": ["GET", "HEAD"], "domain": null }, "checkout.payment_canceled.store": { "uri": "en\/checkout\/payment-canceled\/{orderId}", "methods": ["GET", "HEAD"], "domain": null }, "cart.index": { "uri": "en\/cart", "methods": ["GET", "HEAD"], "domain": null }, "cart.items.store": { "uri": "en\/cart\/items", "methods": ["POST"], "domain": null }, "cart.items.update": { "uri": "en\/cart\/items\/{cartItemId}", "methods": ["PUT"], "domain": null }, "cart.items.destroy": { "uri": "en\/cart\/items\/{cartItemId}", "methods": ["DELETE"], "domain": null }, "cart.shipping_method.store": { "uri": "en\/cart\/shipping-method", "methods": ["POST"], "domain": null }, "wishlist.store": { "uri": "en\/wishlist", "methods": ["POST"], "domain": null }, "countries.states.index": { "uri": "en\/countries\/{code}\/states", "methods": ["GET", "HEAD"], "domain": null }, "home": { "uri": "en", "methods": ["GET", "HEAD"], "domain": null }, "cookie_bar.accepted": { "uri": "en\/cookie-bar", "methods": ["POST"], "domain": null }, "products.quick_view.show": { "uri": "en\/products\/{slug}\/quick-view", "methods": ["GET", "HEAD"], "domain": null }, "current_theme.store": { "uri": "en\/current-theme", "methods": ["POST"], "domain": null }, "pages.show": { "uri": "en\/{slug}", "methods": ["GET", "HEAD"], "domain": null } },
...
! function(e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("route", [], t) : "object" == typeof exports ? exports.route = t() : e.route = t() }(this, function() {
    return function(e) {
        var t = {};
        ...
        e.exports = {
            ...
            merge: function e(t, r, i) {
                ...
                }), t) : Object.keys(r).reduce(function(t, o) { var a = r[o]; return n.call(t, o) ? t[o] = e(t[o], a, i) : t[o] = a, t }, u)
            }
        }
    }, function(e, t, r) {
        "use strict";
        ...
        var n = r(0),
            ...
            a = { brackets: function(e) { return e + "[]" }, comma: "comma", indices: function(e, t) { return e + "[" + t + "]" }, repeat: function(e) { return e } },
            u = Array.isArray,
            c = Array.prototype.push,
            l = function(e, t) { c.apply(e, u(t) ? t : [t]) },
            s = Date.prototype.toISOString,
            f = o.default,
            p = { addQueryPrefix: !1, allowDots: !1, charset: "utf-8", charsetSentinel: !1, delimiter: "&", encode: !0, encoder: n.encode, encodeValuesOnly: !1, format: f, formatter: o.formatters[f], indices: !1, serializeDate: function(e) { return s.call(e) }, skipNulls: !1, strictNullHandling: !1 },
            ...
            var r, n = e,
                c = function(e) {
                    ...
                    var n = o.formatters[r],
                        a = p.filter;
                    return ("function" == typeof e.filter || u(e.filter)) && (a = e.filter), { addQueryPrefix: "boolean" == typeof e.addQueryPrefix ? e.addQueryPrefix : p.addQueryPrefix, allowDots: void 0 === e.allowDots ? p.allowDots : !!e.allowDots, charset: t, charsetSentinel: "boolean" == typeof e.charsetSentinel ? e.charsetSentinel : p.charsetSentinel, delimiter: void 0 === e.delimiter ? p.delimiter : e.delimiter, encode: "boolean" == typeof e.encode ? e.encode : p.encode, encoder: "function" == typeof e.encoder ? e.encoder : p.encoder, encodeValuesOnly: "boolean" == typeof e.encodeValuesOnly ? e.encodeValuesOnly : p.encodeValuesOnly, filter: a, formatter: n, serializeDate: "function" == typeof e.serializeDate ? e.serializeDate : p.serializeDate, skipNulls: "boolean" == typeof e.skipNulls ? e.skipNulls : p.skipNulls, sort: "function" == typeof e.sort ? e.sort : null, strictNullHandling: "boolean" == typeof e.strictNullHandling ? e.strictNullHandling : p.strictNullHandling }
                }(t);
        ...
        var n = r(0),
            ...
            i = { allowDots: !1, allowPrototypes: !1, arrayLimit: 20, charset: "utf-8", charsetSentinel: !1, comma: !1, decoder: n.decode, delimiter: "&", depth: 5, ignoreQueryPrefix: !1, interpretNumericEntities: !1, parameterLimit: 1e3, parseArrays: !0, plainObjects: !1, strictNullHandling: !1 },
            a = function(e) { return e.replace(/&#(\d+);/g, function(e, t) { return String.fromCharCode(parseInt(t, 10)) }) },
            u = function(e, t, r) {
                if (e) {
        ...
        var o = function() {
                function e(t, r, n) {
                    if (function(e, t) { if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, e), this.name = t, this.ziggy = n, this.route = this.ziggy.namedRoutes[this.name], void 0 === this.name) throw new Error("Ziggy Error: You must provide a route name");
                ...
                var t, r;
                return t = e, (r = [{ key: "setDomain", value: function() { if (!this.absolute) return "/"; if (!this.route.domain) return this.ziggy.baseUrl.replace(/\/?$/, "/"); var e = (this.route.domain || this.ziggy.baseDomain).replace(/\/+$/, ""); return this.ziggy.basePort && e.replace(/\/+$/, "") === this.ziggy.baseDomain.replace(/\/+$/, "") && (e = this.ziggy.baseDomain + ":" + this.ziggy.basePort), this.ziggy.baseProtocol + "://" + e + "/" } }, { key: "construct", value: function() { return this.domain + this.path } }]) && n(t.prototype, r), e
            }(),
            i = r(2);
            ...
            return (l = function(e) {
                ...
                function n() {
                    return function(e, t, r) {
                        return (function() { if ("undefined" == typeof Reflect || !Reflect.construct) return !1; if (Reflect.construct.sham) return !1; if ("function" == typeof Proxy) return !0; try { return Date.prototype.toString.call(Reflect.construct(Date, [], function() {})), !0 } catch (e) { return !1 } }() ? Reflect.construct : function(e, t, r) {
                            var n = [null];
                            n.push.apply(n, t);
        ...
        var p = function(e) {
            function t(e, r, n) { var i, a = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null; return function(e, t) { if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, t), (i = function(e, t) { return !t || "object" !== u(t) && "function" != typeof t ? function(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e }(e) : t }(this, f(t).call(this))).name = e, i.absolute = n, i.ziggy = a || Ziggy, i.urlBuilder = i.name ? new o(e, n, i.ziggy) : null, i.template = i.urlBuilder ? i.urlBuilder.construct() : "", i.urlParams = i.normalizeParams(r), i.queryParams = {}, i.hydrated = "", i }
            var r, n;
            return function(e, t) {
                if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
                e.prototype = Object.create(t && t.prototype, { constructor: { value: e, writable: !0, configurable: !0 } }), t && s(e, t)
            }(t, l(String)), r = t, (n = [{ key: "normalizeParams", value: function(e) { return void 0 === e ? {} : ((e = "object" !== u(e) ? [e] : e).hasOwnProperty("id") && -1 == this.template.indexOf("{id}") && (e = [e.id]), this.numericParamIndices = Array.isArray(e), a({}, e)) } }, { key: "with", value: function(e) { return this.urlParams = this.normalizeParams(e), this } }, { key: "withQuery", value: function(e) { return a(this.queryParams, e), this } }, { key: "hydrateUrl", value: function() { var e = this; if (this.hydrated) return this.hydrated; var t = this.template.replace(/{([^}]+)}/gi, function(t, r) { var n, o, i = e.trimParam(t); if (e.ziggy.defaultParameters.hasOwnProperty(i) && (n = e.ziggy.defaultParameters[i]), n && !e.urlParams[i]) return delete e.urlParams[i], n; if (e.numericParamIndices ? (e.urlParams = Object.values(e.urlParams), o = e.urlParams.shift()) : (o = e.urlParams[i], delete e.urlParams[i]), void 0 === o) { if (-1 === t.indexOf("?")) throw new Error("Ziggy Error: '" + i + "' key is required for route '" + e.name + "'"); return "" } return o.id ? encodeURIComponent(o.id) : encodeURIComponent(o) }); return null != this.urlBuilder && "" !== this.urlBuilder.path && (t = t.replace(/\/+$/, "")), this.hydrated = t, this.hydrated } }, {
                key: "matchUrl",
                value: function() {
            ...
            }, { key: "constructQuery", value: function() { if (0 === Object.keys(this.queryParams).length && 0 === Object.keys(this.urlParams).length) return ""; var e = a(this.urlParams, this.queryParams); return Object(i.stringify)(e, { encodeValuesOnly: !0, skipNulls: !0, addQueryPrefix: !0, arrayFormat: "indices" }) } }, {
                key: "current",
                value: function() {
                    var e = this,
                        r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                        n = Object.keys(this.ziggy.namedRoutes),
                        o = n.filter(function(r) { return -1 !== e.ziggy.namedRoutes[r].methods.indexOf("GET") && new t(r, void 0, void 0, e.ziggy).matchUrl() })[0];
                    if (r) { var i = new RegExp("^" + r.replace("*", ".*").replace(".", ".") + "$", "i"); return i.test(o) }
                    return o
                }
            }, { key: "check", value: function(e) { return Object.keys(this.ziggy.namedRoutes).includes(e) } }, {
                key: "extractParams",
                value: function(e, t, r) {
                    var n = this,
                        o = e.split(r);
                    return t.split(r).reduce(function(e, t, r) { return 0 === t.indexOf("{") && -1 !== t.indexOf("}") && o[r] ? a(e, (i = {}, u = n.trimParam(t), c = o[r], u in i ? Object.defineProperty(i, u, { value: c, enumerable: !0, configurable: !0, writable: !0 }) : i[u] = c, i)) : e; var i, u, c }, {})
                }
            }, { key: "parse", value: function() { this.return = this.hydrateUrl() + this.constructQuery() } }, { key: "url", value: function() { return this.parse(), this.return } }, { key: "toString", value: function() { return this.url() } }, { key: "trimParam", value: function(e) { return e.replace(/{|}|\?/g, "") } }, { key: "valueOf", value: function() { return this.url() } }, { key: "params", get: function() { var e = this.ziggy.namedRoutes[this.current()]; return a(this.extractParams(window.location.hostname, e.domain || "", "."), this.extractParams(window.location.pathname.slice(1), e.uri, "/")) } }]) && c(r.prototype, n), t
        }();

        function d(e, t, r, n) { return new p(e, t, r, n) }
    }]).default
});
...
(function() {
  ...
  function df(a, b, c, d) {
    ...
    if (h && h.length) {
      ...
      f = df(
        k.index,
        { B: f, w: 1 === k.fe ? b.terminate : f, terminate: b.terminate },
        c,
        d
      );
    }
  ...
  var nm = function(a, b, c, d) {
    ...
    fm = function(a, b, c, d) {
      ...
      for (var p = 0; p < u.length; ++p) {
        ...
        } else t === H.S && 0 > r(u, H.Fb) && (k.cookieName = v + "_ga");
      }
      jm(k, "cookieDomain", "auto");
      jm(h, "forceSSL", !0);
      jm(f, "eventCategory", sm(c));
